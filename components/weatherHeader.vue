      ...
      <div class="weather__stats">
        ...
        <div class="pressure d-flex align-center ga-1">
            <span class="pressure__icon">
                <svg class="stats-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                     stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier"
                    ...
                    stroke="#ffffff" stroke-linecap="round"></path> <path
                    ...
                    stroke="#ffffff"></path> <path d="M12 6V8" stroke="#ffffff" stroke-linecap="round"></path> <path
                    d="M5.63599 8.63574L7.0502 10.05" stroke="#ffffff" stroke-linecap="round"></path> <path
                    d="M18.364 8.63574L16.9498 10.05" stroke="#ffffff" stroke-linecap="round"></path> <path
                    d="M20.6934 17.3291L18.7615 16.8115" stroke="#ffffff" stroke-linecap="round"></path> <path
        ...
        <div class="humidity d-flex align-center ga-1">
              ...
              <svg class="stats-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g
